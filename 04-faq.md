...
1. **Breathing technique.** Are you breathing *fast and hard*? Fast-deep-effortful breathing is the single biggest determinant. See [Aborting with oxygen](02-aborting-with-oxygen.md#the-breathing-technique-read-this-first).
2. **Start time.** Are you starting at the first sign of an attack, or waiting? Earlier is dramatically more effective.
3. **Flow rate.** Is it high enough? 15 L/min is the floor, not the target. Aim for 25 L/min and higher if your setup supports it.
4. **Seal and dilution.** If you use a mask: is the seal tight? Are the basic-NRM side vents taped shut?
5. **Equipment.** Do you actually have a non-rebreather, ClusterO2 kit, or demand valve? A simple (Hudson) face mask or nasal cannula will not work.
...
**Demand valve, if you can.** It delivers 100% oxygen on demand, with no waste between breaths and no dilution. In the Petersen 2017 trial it halved the need for rescue medication compared to a standard non-rebreather mask, and 62% of patients preferred it overall. The barrier is cost ($250–400+) and availability.
...
2. Attach the American Headache Society guideline and the 2009 Cohen JAMA trial to your appeal.
3. Ask your doctor to do a **peer-to-peer review** — a phone call with the insurer's medical reviewer. These are often decisive.
4. If appeals fail, escalate to your state insurance commissioner (US) or equivalent patient advocate.
5. Don't go without treatment while the paperwork processes — you can pay a DME supplier out of pocket, or use [welding oxygen](08-welding-oxygen.md) as a stopgap.

See [Getting a prescription → Insurance and coverage](03-getting-a-prescription.md#insurance-and-coverage) for the full walkthrough.
